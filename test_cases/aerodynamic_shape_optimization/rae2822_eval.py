...
def main():
    ...
    sys.stdout.write('|   / __| | | |_  )   Release 6.1.0 \"Falcon\"                            |\n')
...
def shape_optimization( filename,projectname = '',
                        partitions  = 0                    ,
    ...
    x0          = [0.00]*n_dv # initial design
 
    with open('desvar.txt','r') as desfil:
        for i in range(0,n_dv):
            x0[i]=float(desfil.readline())
    print x0
